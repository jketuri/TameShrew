...
gcc $OPTIONS -I../osgART/include -I../osgearth/src -W -Wall -fPIC -c Datum.cpp LiveView.cpp NMEA.cpp ObjectPlacer.cpp SerialStream.cpp SocketStream.cpp USBStream.cpp common.cpp
check
